...
<div class="row align-items-center choose-c">
    ...
    <div id="produkhukum-table_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
        ...
        <table id="tableabout" class="table table-bordered table-striped">
            <thead>
                <tr>
                    <th></th>
                    <th></th>
            ...
            <tbody>
                @foreach ($data as $d)
                <tr>
                    <td><img class="imgprodukhukum" src="https://smartcity.tangerangkota.go.id/assets/gambar/pdf.png"></td>
                    <td>{{$d->title}}</td>
                </tr>
                @endforeach
            </tbody>
